...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener
{
    ...
    Button buttonNumber0, buttonNumber1, buttonNumber2, buttonNumber3, buttonNumber4, buttonNumber5, buttonNumber6,
            buttonNumber7, buttonNumber8, buttonNumber9, buttonClear, buttonParentheses, buttonPercent, buttonDivision,
            buttonMultiplication, buttonSubtraction, buttonAddition, buttonEqual, buttonDot;
